...
feature "Blank Slate", %q{
  ...
  scenario "Blank site allows first user to send setup email to owner" do
    ...
    "owen@example.com".should receive_email(subject: "Setup instruction for Bitcoin Payment Service")
    ...
    # Clicking link a second time still works while site has not been setup
    click_link_in_email "setup your BPS now", to: "owen@example.com"
    page.should have_content "Setup you Bitcoin Payment Service"
    ...
    page.should have_content "If you lose it, you lose access to your bitcoins"
